  ...
  public class Area
  {
    ...
    public IList<Asar> AllActiveAsars
    {
      get
      {
        ...
        return Container.Instances<Asar>().Where(d => allchildrenids.Contains(d.Area.AreaId) && d.AsarStatus == (int)AllEnums.AsarStatus.সচল).OrderBy(o => o.Name).ToList();
      }
    }
    ...
    public IList<Asar> AllNewAsars
    {
      get
      {
        ...
        return Container.Instances<Asar>().Where(d => allchildrenids.Contains(d.Area.AreaId) && d.AsarStatus == (int)AllEnums.AsarStatus.নতুন).OrderBy(o => o.Name).ToList();
      }
    }
    ...
    public IList<Asar> AllRevivedAsars
    {
      get
      {
        ...
        return Container.Instances<Asar>().Where(d => allchildrenids.Contains(d.Area.AreaId) && d.AsarStatus == (int)AllEnums.AsarStatus.পুনর্জাগরণ).OrderBy(o => o.Name).ToList();
      }
    }
    ...
    public IList<Asar> AllInactiveAsars
    {
      get
      {
        ...
        return Container.Instances<Asar>().Where(d => allchildrenids.Contains(d.Area.AreaId) && d.AsarStatus == (int)AllEnums.AsarStatus.নিষ্ক্রিয়).OrderBy(o => o.Name).ToList();
      }
    }
