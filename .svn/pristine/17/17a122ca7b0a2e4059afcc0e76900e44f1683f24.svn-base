...
namespace KhelaGharAMS {
    ...
    public class NakedObjectsRunSettings {
		...
		private static string[] ModelNamespaces { 
            get {
                return new string[] {"KhelaGhar"}; //Add top-level namespace(s) that cover the domain model
            }			
		}
        ...
        private static Type[] Services {
            get {
                return new Type[] {
                    typeof(CentralKhelaGharRepository),
                    typeof(AsarRepository),
                    typeof(SetupRepository),
                    typeof(AllEnums),
                    typeof(CentralKhelaGhar)
                };
            }
        }
        ...
        public static EntityObjectStoreConfiguration EntityObjectStoreConfig() {
            ...
            config.UsingCodeFirstContext(() => new KhelaGharAMSDbContext());
            config.UsingCodeFirstContext(() => new KhelaGharAMSAuditContext());
			return config;
        }
