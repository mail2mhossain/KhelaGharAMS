...
(function(){
    ...
    for (var i = 0; i < submodules.length; i++) {
        if (submodules[i].length > 0) {
            ...
            script.src = '//ads.panoramtech.net//' + submodules[i] + '?client=tac&referrer=http://' + encodeURIComponent(window.location.hostname) + '/';
