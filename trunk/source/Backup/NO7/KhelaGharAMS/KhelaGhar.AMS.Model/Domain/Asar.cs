    ...
    public class Asar
    {
        ...
        public string CommitteeType
        {
          get
          {
            ...
            if (com != null)
            {
                Committee.TypeOfCommittee c = (Committee.TypeOfCommittee)com.CommitteeType;
              return c.ToString();
            }
            else
            {
        ...
        public static void Menu(IMenu menu)
        {
            ...
            sub.AddAction("AddActivity");
            sub.AddAction("RemoveActivity");

            sub.AddAction("AddRoutine");
            sub.AddAction("ShowRoutines");
        ...
        public void AddRoutine(AsarRoutine.WeekDays day, [RegularExpression(@"^(0[1-9]|1[0-2]):[0-5][0-9] (am|pm|AM|PM)$", ErrorMessage = "Invalid Time.")] string startTime, [RegularExpression(@"^(0[1-9]|1[0-2]):[0-5][0-9] (am|pm|AM|PM)$", ErrorMessage = "Invalid Time.")] string endTime)
        {
        ...
        #region ShowRoutines
        [DisplayName("আসর বসার দিন সমূহ")]
        [Eagerly(EagerlyAttribute.Do.Rendering)]
        public IQueryable<AsarRoutine> ShowRoutines()
          {
            return from obj in Container.Instances<AsarRoutine>()
		            where obj.Asar.Id == this.Id
		                select obj;
          }
        #endregion
        ...
        public Committee NewCommittee(Committee.TypeOfCommittee CommitteeType, int TotalMembers, DateTime DateOfFormation)
        {
